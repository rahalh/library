namespace Media.API.Ports.HTTP
{
    ...
    public static class MediaEndpoints
    {
        public static IEndpointRouteBuilder MapMediaEndpoints(this IEndpointRouteBuilder endpoints)
        {
            ...
            endpoints.MapGet("/api/media", async ([FromServices] IMediaService service, string pageToken, int? pageSize, CancellationToken token) => await ListMedia.Handler(service, new ListRequest(pageToken, pageSize), token));
